getDatTrendStatsOverviewInd <- function(id='indCap_CAP', datCamelIndNorm, roundInd=TRUE, idsDecreasing = FALSE) {
  ...
  source('LASPUMSS/APLICACION-DE-LA-METODOLOGIA-CAMEL-BOLIVIA/R/camel-get-dat-tendencia-indicadores.R')
  source('LASPUMSS/APLICACION-DE-LA-METODOLOGIA-CAMEL-BOLIVIA/R/camel-get-dat-estadistica-descriptiva-indicadores.R')
